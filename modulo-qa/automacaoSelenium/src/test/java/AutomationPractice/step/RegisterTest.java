...
public class RegisterTest extends BaseStep {
    ...
    public void deveCriarNovoUsuario() {
        ...
        MatcherAssert.assertThat(driver.findElement(By.cssSelector("#page-36 > div > div.woocommerce > div > p:nth-child(1)")).getText(), containsString("Hello") );
    }
